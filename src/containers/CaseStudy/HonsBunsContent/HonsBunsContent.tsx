...
// components
import { CSHero, CSHeader, CSFooter } from "../../../components/index";
    ...
    <>
      <div className={styles.csWrapper}>
        ...
        <div id="top" className={styles.csWrapper}>
          ...
          >
            <CSHero imgSrc="https://res.cloudinary.com/da0wdy90u/image/upload/v1670107844/portfolio/hb-hero_mdkggo_bkegyh.jpg" />
          </div>

  ...
  return (
    <>
      ...
      <ContentBlock
        title="The Problem"
      >
        <p>Everyone loves bunnies but not everyone understands just how much work goes into caring for one (or more). Every year about 35,000 bunnies get adopted, but unfortunately, a large number of them either end up getting returned, or abandoned due to the amount of work involved in raising a bunny as a pet. We wanted to build an NFT project that would help bunnies find a loving home with a long life there.</p>
      </ContentBlock>

      <ContentBlock
        flipped
        row
        imgSrc='https://res.cloudinary.com/austinmel/image/upload/v1651105963/bunny_fmaezv.png'
        width="522"
        height="530"
        altText="image of emily with her bunnies"
      >
      ...
      <ContentBlock
        row
        imgSrc='https://res.cloudinary.com/austinmel/image/upload/v1651108597/bunnies_icemtj.png'
        width="522"
        height="530"
      >
